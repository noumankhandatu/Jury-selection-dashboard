...
export default function AIQuestionGenerator({ caseData, onAddQuestions }: AIQuestionGeneratorProps) {
  ...
  const generateQuestions = async () => {
    ...
    try {
      ...
      const prompt = `
You are an expert jury consultant helping to create voir dire questions for jury selection. Based on the case information provided, generate exactly 10 relevant and effective jury selection questions.
...
Generate 10 specific voir dire questions that would help identify jurors who match the ideal traits or reveal potential biases relevant to this case. The questions should be:
1. Clear and direct

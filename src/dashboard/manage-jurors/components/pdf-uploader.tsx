...
import { Upload, Brain, Sparkles, Loader2 } from "lucide-react";
import CardHeaderTag from "@/components/shared/card-header";
import { itemVariants } from "@/utils/fn";

export function PDFUploader({ selectedCase, onFileUpload, isUploading, uploadError, uploadSuccess }: any) {
  ...
  return (
    <Card className="bg-white/80 backdrop-blur-md shadow-xl rounded-2xl overflow-hidden relative z-10">
      <CardHeaderTag
        ...
        description={`Upload PDF files and let AI extract juror information for ${selectedCase.name}`}
        Icon={Brain}
      />
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-center gap-2 text-sm text-purple-700">
                    ...
                    <span>Uploading PDF to OpenAI servers</span>
                  </div>
                ...
                <p className="text-xs text-gray-600 mt-4">This may take 10-30 seconds depending on PDF size...</p>
              </div>
          ...
          <div className="border-2 border-dashed border-purple-300 rounded-lg p-6 sm:p-8 bg-gradient-to-br from-purple-50/50 to-blue-50/50 backdrop-blur-sm transition-all duration-300 hover:border-purple-400 hover:bg-purple-50/70">
            <div className="flex flex-col items-center text-center">
              ...
              <div className="space-y-2 mb-4">
                ...
                <p className="text-sm text-gray-600">Upload any juror questionnaire PDF and AI will extract all information</p>
                <p className="text-xs text-purple-600 font-medium">✨ Powered by OpenAI GPT-4</p>
              </div>
              ...
              <input id="pdfUpload" type="file" accept=".pdf" onChange={handleFileChange} className="hidden" />
              ...
              <div className="mt-6 p-4 bg-gradient-to-r from-purple-50 to-blue-50 rounded-lg border border-purple-200">
                ...
                <ul className="text-xs text-purple-800 space-y-1 text-left">
                  <li>• Extracts juror information from any PDF format</li>

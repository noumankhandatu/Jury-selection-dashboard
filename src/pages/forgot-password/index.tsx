...
export default function ForgotPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error(err);
      const errorMsg = err?.response?.data?.message || "Failed to send reset instructions. Please try again.";
      ...
      >
        <div className="flex flex-col items-center w-full">
          <div className="mb-6">
            ...
            <p className="text-gray-600 text-center mt-2 text-sm">Enter your email to receive reset instructions</p>
          </div>
